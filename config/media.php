...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Правила валидации для медиа-файлов и метаданных.
    |
    */
    'validation' => [
        'dimensions' => [
            // Максимальные разумные размеры изображения (100000x100000 px = 10 gigapixels)
            // Защита от overflow и DoS атак
            'max' => (int) env('MEDIA_MAX_DIMENSION', 100_000),
        ],
    ],
];
