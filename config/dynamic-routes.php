...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Настройки валидации для динамических маршрутов.
    |
    */
    'validation' => [
        // Проверять существование контроллеров при создании маршрутов
        'check_controller_exists' => env('ROUTES_VALIDATE_CONTROLLERS', true),

        // Проверять существование views при создании маршрутов
        'check_view_exists' => env('ROUTES_VALIDATE_VIEWS', true),

        // Разрешённые namespace для контроллеров
        'allowed_controller_namespaces' => [
