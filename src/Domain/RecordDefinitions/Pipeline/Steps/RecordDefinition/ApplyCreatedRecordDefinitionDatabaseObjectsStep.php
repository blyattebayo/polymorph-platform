...
final class ApplyCreatedRecordDefinitionDatabaseObjectsStep extends AbstractStep
{
    ...
    {
        return 'record-definition.create.database-objects';
    }

    public function requires(): array
    {
        return ['state.created_record_definition'];
    }

    public function run(PipelineContext $context): StepResult
    {
        /** @var CreateRecordDefinitionContext $context */
        $definition = $context->createdRecordDefinition
            ?? throw new \LogicException('Created record definition is required');
