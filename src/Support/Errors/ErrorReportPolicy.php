...
final class ErrorReportPolicy
{
     ...
     * Но опускать 4xx ниже `warning` нельзя: при типичном production-уровне
     * `LOG_LEVEL=warning` значение `info` означало бы, что 401, 403 и 409 не видны
     * вообще. Шум лечится уровнем, а не потерей события.
     */
