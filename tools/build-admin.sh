...
#
# Run this before tagging/publishing a platform release, and commit the result.
# Composer package versions and the embedded frontend contract are explicit, so the
# release tag, composer.json files, generated bundle and runtime must all agree.
#
set -euo pipefail
...
echo "==> Done."
echo "    Next: verify that package, SDK, bundle and release-tag versions agree."
