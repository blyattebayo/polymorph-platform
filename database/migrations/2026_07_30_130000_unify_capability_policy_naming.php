...
return new class extends Migration
{
    ...
    /**
     * Намерение из докблока сделано исполняемым. Без этого метода Laravel
     * считает миграцию откатываемой (вызов обёрнут в method_exists), поэтому
     * migrate:rollback отрабатывал пустышкой, печатал миграцию как откаченную
     * и вычёркивал её из таблицы — база оставалась в новой конвенции, а история
     * утверждала обратное.
     */
    public function down(): void
    {
        throw new RuntimeException(
            'Переименование capability необратимо: восстановите базу из резервной копии.',
        );
    }
};
