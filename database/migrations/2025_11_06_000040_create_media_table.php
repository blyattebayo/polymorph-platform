 ...
 * Таблица media_images хранит специфичные метаданные изображений (width, height).
 *
...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('media', function (Blueprint $table): void {
            ...
            $table->string('checksum_sha256', 64)->unique(); // UNIQUE constraint для предотвращения race condition
